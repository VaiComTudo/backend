...
public class OwnerController {
    ...
    public ResponseEntity<Listing> addListing(@RequestParam UUID id, @RequestBody Listing listing) {
    ...
    public ResponseEntity<Set<Listing>> getListings(@RequestParam UUID id) {
